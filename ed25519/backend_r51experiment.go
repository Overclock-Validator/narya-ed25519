...
type r51IFMAPipeline struct {
	...
	variableX8        *r51x5.ExperimentalIFMAProjectiveNielsMicroAoSVariableBaseWorkspaceX8
...
func newR51IFMACombPipeline(kind r51IFMAPipelineKind, variableRadixBits, fixedRadixBits uint) (*r51IFMAPipeline, error) {
	...
	if kind == r51IFMAX8 {
		pipeline.variableX8 = new(r51x5.ExperimentalIFMAProjectiveNielsMicroAoSVariableBaseWorkspaceX8)
	} else {
		halves := 1
		if kind == r51IFMATwoX4 {
			halves = 2
