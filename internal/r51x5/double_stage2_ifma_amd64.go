...
// ifmaDoubleStage2SquareTrickX8 consumes raw [X^2,Y^2,Z^2,(X+Y)^2]
// products and derives E=(X+Y)^2-X^2-Y^2 instead of doubling X*Y. It is an
// unwired experiment for pricing a fourth dedicated square against the
// normalized X+Y preparation it requires.
//
//go:noescape
