// Package r51x5 contains the radix-2^51 models and native primitives behind
// Narya's explicitly forced lane-per-signature AVX-512 IFMA backend.
//
...
//
// ElementX4 and ElementX8 store [limb][lane] data. Their ordinary methods
// deliberately perform scalar lane-by-lane arithmetic and remain independent
// correctness oracles for packing, lane isolation, and exact field semantics.
// The forced r51 verifier uses the separately typed IFMAElementX4 schedule;
// automatic backend selection remains outside this package and stays generic.
//
